...
### Customer Engineering Manager @ Google Cloud | AI Leadership | Applied AI Engineering

I lead technical teams and strategy at **Google Cloud (Australia)**, focusing on the intersection of frontier AI research and enterprise scale business transformation. I am passionate about solving for **measurable outcomes** through the applied use of generative technology.

---

## 🎨 Multimodal Generative Media & Creative Strategy
I leverage a diverse, state-of-the-art model ecosystem to redefine marketing, media, and product storytelling:
...
## 📫 Where to find me
- **LinkedIn:** [linkedin.com/in/aspaulding](https://au.linkedin.com/in/aspaulding)
- **Hugging Face:** [huggingface.co/spaulds](https://huggingface.co/spaulds)
- **Google Cloud:** Supporting enterprise customers in the ANZ region. Say hello 👋 

Some clever person once said, "the value of AI is not in the model itself, but in the outcomes it enables for people."
